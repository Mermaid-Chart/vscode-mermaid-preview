 ...
 *
 * Diagram type comes from the block source (frontmatter stripped, version suffix dropped)
 * because the mermaid render itself happens in a webview owned by the built-in Markdown
 * extension which cannot message us back. For the same reason no render outcome is reported.
 */
