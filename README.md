...
Now we offer a feature rich experience to create, visualize and edit Mermaid diagrams locally without needing to create any account. Made with ❤️from the creators of Mermaid.js and we strive to provide the best Mermaid experience and provide regular updates.
...
![Image illustrating accessible diagrams in explorer panel](./images/image14.gif "Extension overview")
...
![Real-Time local Edit & Preview](./images/image13.png "Real-Time local Edit & Preview")
...
![Syntax Highlighting](./images/image17.png "Syntax Highlighting")
...
![Pan & Zoom](./images/image12.png "Pan & Zoom")
...
![Error Highlighting](./images/image2.png "Error Highlighting")
...
![Auto-Detect Mermaid diagrams in Markdown files](./images/image4.png "Auto-Detect Mermaid diagrams in Markdown files")
...
![Support .mmd file extension as Mermaid Markdown file](./images/image3.png "Support .mmd file extension as Mermaid Markdown file")
...
![Smart Auto-Suggest with code snippets](./images/image5.png "Smart Auto-Suggest with code snippets")
...
![Diagram Help](./images/image6.png "Diagram Help")
...
![Fetch & Use existing diagrams in Side Panel](./images/image1.png "Fetch & Use existing diagrams in Side Panel")
...
![Download](./images/image16.png "Download")
...
![Link Diagrams](./images/image10.png "Link Diagram")
...
![Smart Sync to promote collaboration 1](./images/image21.png "Smart Sync to promote collaboration")

![Smart Sync to promote collaboration 2](./images/image20.png "Smart Sync to promote collaboration")

#### Refresh 
To get the latest changes of diagrams from Mermaid Chart, click on the button named Refresh at the top in the side panel.

![Refresh ](./images/image18.png "Refresh ")
...
![Open in Web View 1](./images/image10.png "Open in Web View 1")

![Open in Web View 2](./images/image9.png "Open in Web View 2")
...
![Open in Web View 2](./images/image7.png "Open in Web View 2")
